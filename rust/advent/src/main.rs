...
fn main() {
    ...
    let result = match id {
        ...
        "19a" => day19::calc19a(read_lines()),
        "19b" => day19::calc19b(read_lines()),
        "20a" => day20::calc20a(read_lines()),
        "20b" => day20::calc20b(read_lines()),
        "21a" => day21::calc21a(read_lines()),
        "22a" => day22::calc22a(read_lines()),
        "22b" => day22::calc22b(read_lines()),
